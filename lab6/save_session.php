 ...
 * save_session.php
 *
 * Обработка формы добавления учебной сессии.
 *
 * Функционал:
 * - проверка метода запроса (POST)
 * - валидация входных данных через StudySessionValidator
 * - отображение ошибок при некорректных данных
 * - создание новой записи учебной сессии
 * - сохранение данных в JSON-файл (data.json)
 * - вывод страницы успешного сохранения
 *
 * @author Student
 * @version 1.0
 */
