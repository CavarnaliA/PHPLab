 ...
 * list_sessions.php
 *
 * Страница отображения списка учебных сессий.
 * Данные загружаются из файла data.json, сортируются
 * и выводятся в виде таблицы.
 *
 * Функционал:
 * - загрузка данных из JSON-файла
 * - проверка корректности данных
 * - сортировка по дате, длительности или предмету
 * - безопасный вывод данных (htmlspecialchars)
 * - отображение таблицы или сообщения об отсутствии записей
 *
 * @author Student
 * @version 1.0
 */
