 ...
 * index.php
 *
 * Главная страница приложения "Трекер учебных сессий".
 * Отображает форму для добавления информации об учебном занятии.
 *
 * Функционал:
 * - ввод предмета
 * - выбор даты занятия
 * - указание длительности
 * - выбор сложности и результата
 * - добавление заметок
 * - переход к списку сохранённых сессий
 *
 * @author Student
 * @version 1.0
 */
